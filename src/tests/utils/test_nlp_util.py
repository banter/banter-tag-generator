...
class TestNLPUtil(unittest.TestCase):
    ...
    starting_dict = {"ab": "cd"}
    span_list = []
    sample_token = {'id': '1', 'text': 'Tom', 'upos': 'PROPN', 'xpos': 'NNP', 'feats': 'Number=Sing', 'misc': 'start_char=0|end_char=3'}
    sample_nlp_response_list = [[{'id': '1', 'text': 'Tom', 'upos': 'PROPN', 'xpos': 'NNP', 'feats': 'Number=Sing', 'misc': 'start_char=0|end_char=3'}, {'id': '2', 'text': 'Brady', 'upos': 'PROPN', 'xpos': 'NNP', 'feats': 'Number=Sing', 'misc': 'start_char=4|end_char=9'}], [{'id': '1', 'text': 'Is', 'upos': 'AUX', 'xpos': 'VBZ', 'feats': 'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin', 'misc': 'start_char=10|end_char=12'}, {'id': '2', 'text': 'the', 'upos': 'DET', 'xpos': 'DT', 'feats': 'Definite=Def|PronType=Art', 'misc': 'start_char=13|end_char=16'}, {'id': '3', 'text': 'greates', 'upos': 'NOUN', 'xpos': 'NNS', 'feats': 'Number=Plur', 'misc': 'start_char=17|end_char=24'}, {'id': '4', 'text': 'of', 'upos': 'ADP', 'xpos': 'IN', 'misc': 'start_char=25|end_char=27'}, {'id': '5', 'text': 'all', 'upos': 'DET', 'xpos': 'DT', 'misc': 'start_char=28|end_char=31'}, {'id': '6', 'text': 'time', 'upos': 'NOUN', 'xpos': 'NN', 'feats': 'Number=Sing', 'misc': 'start_char=32|end_char=36'}, {'id': '7', 'text': '.', 'upos': 'PUNCT', 'xpos': '.', 'misc': 'start_char=36|end_char=37'}], [{'id': '1', 'text': 'Jared', 'upos': 'PROPN', 'xpos': 'NNP', 'feats': 'Number=Sing', 'misc': 'start_char=38|end_char=43'}, {'id': '2', 'text': 'is', 'upos': 'AUX', 'xpos': 'VBZ', 'feats': 'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin', 'misc': 'start_char=44|end_char=46'}, {'id': '3', 'text': 'the', 'upos': 'DET', 'xpos': 'DT', 'feats': 'Definite=Def|PronType=Art', 'misc': 'start_char=47|end_char=50'}, {'id': '4', 'text': 'quarterback', 'upos': 'NOUN', 'xpos': 'NN', 'feats': 'Number=Sing', 'misc': 'start_char=51|end_char=62'}, {'id': '5', 'text': 'for', 'upos': 'ADP', 'xpos': 'IN', 'misc': 'start_char=63|end_char=66'}, {'id': '6', 'text': 'the', 'upos': 'DET', 'xpos': 'DT', 'feats': 'Definite=Def|PronType=Art', 'misc': 'start_char=67|end_char=70'}, {'id': '7', 'text': 'Rams', 'upos': 'PROPN', 'xpos': 'NNPS', 'feats': 'Number=Plur', 'misc': 'start_char=71|end_char=75'}]]
    ...
    def test_get_nouns_from_sentence(self):
        token_set = set()
        response = self.nlp_util.get_important_pos_tags_from_sentence( self.sample_nlp_response_list,token_set, "ABCDEFG")
    ...
    def test_get_nouns_from_sentence_token_in_concat_str(self):
        token_set = set()
        token_set.add("Jared Goff")
        response = self.nlp_util.get_important_pos_tags_from_sentence( self.sample_nlp_response_list,token_set, "JaredGoff")
        self.assertEqual(3, len(response))
